...
OUTPUT:
https://github.com/astro-NAVEEN/Prompt-Engineering-EXP.NO-5/blob/main/Exp5_Prompting_Patterns_Themed.pptx

RESULT: 
The experiment showed that basic (structured) prompts consistently produced more accurate, detailed, and relevant responses than naïve prompts. Clear instructions improved the quality and depth of ChatGPT's outputs, while naïve prompts often generated shorter and less focused responses.
